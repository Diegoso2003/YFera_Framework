...
"red"						return 'COLOR_D'
"rgb"						return 'RGB'
"right"						return 'DIRECCION'
"RIGHT"						return 'DIRECTION'
"SANS"						return 'FUENTE'
"SANS"(\s+|-)"SERIF"				yytext = "SANS-SERIF"; return 'FUENTE'
"size"						return 'SIZE'
"style"						return 'STYLE'
"text"						return 'TEXT'
"through"					return 'THROUGH'
"to"						return 'TO'
"top"						return 'DIRECCION'
...
atributo : atributo_numerico					{ $$ = $1 }
	...
	| TEXT FONT ASIGNACION FUENTE				{ $$ = new AtributoEstilo("font-family:", $4.toLowerCase()); }
	| TEXT ALIGN ASIGNACION DIRECTION			{ $$ = new AtributoEstilo("text-align:", $4.toLowerCase()); }
	;
...
mod : mod MODULO unario						{ $$ = new Modulo($1, $3); }
